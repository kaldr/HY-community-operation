...
testController = function($scope, $rootScope, getResultFactory, resultToAPIFactory) {
  var setQuestionWithChosen, setStartState, showAnswers, showErrorInfo, showNextQuestion, showPreviousQuestion, vm;
...
angular.module('test').factory("getResultFactory", getResultFactory);

angular.module('test').factory('resultToAPIFactory', resultToAPIFactory);
