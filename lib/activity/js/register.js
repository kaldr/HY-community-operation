var activityAPI, registerController, request;
...
registerController = function(userJoinActivity, $scope, $rootScope, $cookies) {
  var activate, checkPhone, checkUserStatus, joinGame, removeAnimate, saveUserToCookie, showSuccessIcon, showSuccessText, successCallback, vm;
  vm = this;
  vm.loading = false;
...
angular.module("register").factory('userJoinActivity', function($http) {
  return function(data, callback) {
    ...
    return $http(request).then(successCallback, failCallback);
  };
});
